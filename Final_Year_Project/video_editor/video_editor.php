...
$sql="select * from service where speciality='Video Editor'";
        ...
        <a href="../index.php" class="navbar-brand"><img src="images/logo-img.png" alt="logo-img.png" class="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <!--<div class="nav-item">
                  <div class="nav-link">
                    <button type="button" class="btn btn-success" href="login.html">Login</button>
                  </div>
                </div>-->
                 <!--<div class="nav-item">
                  <div class="nav-link">
    ...
    <section id="profiles">
        ...
        <div class="row profile-row">
           ...
           <?php 
                ...
                <a type="button" class="btn btn-info"href="video_editor_profile.php?id=<?php echo $row['service_id'] ?>">View More</a><br><br>
            </div>
            <?php }
}
?>

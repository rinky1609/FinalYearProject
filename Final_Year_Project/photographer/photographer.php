...
$sql="select * from service where speciality='Photographer'";
        ...
        <a href="../index.php" class="navbar-brand"><img src="images/logo-img.png" alt="logo-img.png" class="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
               ...
               <!--<div class="nav-item">
                  <div class="nav-link">
                    <a type="button" class="btn btn-danger" href="../service/service_logout.php">Log out</a>
                  </div>
                </div>-->
                 <!--<div class="nav-item">
                <div class="nav-link">
    ...
    <section id="profiles">
        ...
        <div class="row profile-row">
            ...
            <div class="col-lg-4 profile">
                ...
                <a type="button" class="btn btn-info"href="photographer_profile.php?id=<?php echo $row['service_id'] ?>">View More</a><br><br>
            </div>
            <?php }
}
?>

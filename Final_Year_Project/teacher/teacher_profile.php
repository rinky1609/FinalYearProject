                  ...
                  <div class="card">
                    <div class="card-body">
                     ...
                     if(!$row2['photo_upload'])
                      echo "<img src='../service/service_photo/".'no_profile.png'."' class='rounded-circle' width='150'  >";
                      else   echo "<img src='../service/service_photo/".$row2["photo_upload"]."' class='rounded-circle' width='150'  >"; ?>
                        <div class="mt-3">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary"><?php echo $row2['fb_id'];?></span>
                           ...
                           <hr>
          <video controls src="videos/WhatsApp Video 2023-05-16 at 11.07.14 PM.mp4"></video>
          <hr>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                         <h5><?php echo $row2['speciality'];?></h5>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                  ...
                  <div class="row gutters-sm">
                    <div class="col-sm-12 mb-3">
                      <div class="card h-100">
                        <div class="card-body">
                          <!--<a href="add_skill.php" class="btn btn-primary" style="position:relative; margin-left:720px;">Add Skill</a>-->
                          <h4 class="d-flex align-items-center mb-3" style="position:relative; top:-15px;">My Skills</h4> 
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  ?>
                    ...
                    <a href="../service_booking/service_booking.php?fees=500" type="button" class="btn btn-success pricing-btn">500/-</a>
                  <?php
                  }
                  else
                  { 
                  ...
                  ?>
                <a type="button" class="btn btn-success" href="../user/user_login.php">Please Login First </a>
                ...
                <div class="card-body">
                 ...
                 <?php
                  ...
                  ?>
                    ...
                    <a href="../service_booking/service_booking.php?fees=1000" type="button" class="btn btn-success pricing-btn">1000/-</a>
                  <?php
                  }
                  else
                  { 
                  ...
                  ?>
                <!--<a href="../user/user_login.php"><h4>Please Login First </h4></a>-->
                  <a type="button" class="btn btn-success" href="../user/user_login.php">Please Login First </a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  ?>
                    ...
                    <a href="../service_booking/service_booking.php?fees=2000" type="button" class="btn btn-success pricing-btn">2000/-</a>
                  <?php
                  }
                  else
                  { 

          ...
          <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <div class="nav-item">
                  <div class="nav-link">
                    <a type="button" class="btn btn-danger" href="user_logout.php">Logout</a>
                  </div>
                </div>
              </ul>
            </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                     ...
                     if(!$row2['photo_upload'])
                      echo "<img src='photo_upload/".'no_profile.png'."' class='rounded-circle' width='150'  >";
                      else   echo "<img src='photo_upload/".$row2["photo_upload"]."' class='rounded-circle' width='150'  >"; ?>
                        <div class="mt-3">

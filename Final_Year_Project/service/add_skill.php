          ...
          <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <div class="nav-item">
                  <div class="nav-link">
                    <a type="button" class="btn btn-danger" href="service_logout.php">Log out</a>
                  </div>
                </div>
              </ul>
            </div>
                  ...
                  <div class="row gutters-sm">
                    <div class="col-sm-12 mb-3">
                      <div class="card h-100">
                        <div class="card-body">
                          <h4 class="d-flex align-items-center mb-3" style="position:relative; top:-15px;">My Skill</h4> 
                         <form action="save_skill.php" method="post"> 
                          ...
                          <input type="submit" class="btn btn-primary" style="position:relative; margin-right:720px;" name="submit" value="SAVE">
                          </form>

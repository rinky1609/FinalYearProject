...
$sql="select * from service where speciality='Makeup Artist'";
...
<body>
    ...
    <section id="profiles">
      ...
      <?php 
                ...
                <a type="button" class="btn btn-info"href="makeup_artist_profile.php?id=<?php echo $row['service_id'] ?>">View More</a><br><br>
            </div>
            <?php }
}
?>

...
$sql="select * from service where speciality='Service'";
        ...
        <div class="row profile-row">
            ...
            <div class="col-lg-4 profile">
              ...
              <?php 
                ...
                <a type="button" class="btn btn-info"href="service_profile.php?id=<?php echo $row['service_id'] ?>">View More</a><br><br>
            </div>
            <?php }
}
?>
